...
![](/figures/zuercher2022.png) *Different types of statistics computed from weak gravitational lensing maps can give different precision of measurement of cosmological parameters.*
...
*Footprints of KiDS-1000 survey cut out from full sky simulations. These were used to train the deep convolutional neural networks.*
...
*Weak lensing mass maps from Dark Energy Survey Year 3 data used to find peaks.*
...
*Number of peaks (PC) and minima (MC) counted on the weak lensing maps as a function of their height, for different cosmological models (colored lines)*
